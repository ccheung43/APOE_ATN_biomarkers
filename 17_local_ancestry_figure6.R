# Creating a figure for Figure 6: Interaction of local genetic ancestry counts and APOE allele on ATN biomarkers. 
...
fig_file = "2024_APOE_ATN_biomarkers/Results/20250313_figure6.png"
