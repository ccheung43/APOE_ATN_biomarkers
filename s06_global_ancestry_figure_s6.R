# Creating Figure S6: Associations between ATN biomarkers and APOE allele e2 by global genetic ancestry group
...
fig_file = "2024_APOE_ATN_biomarkers/Results/20250328_figure_s6.png"
...
fig <- df %>% 
  filter(allele == "E2") %>% 
  ggplot(aes(x = proportion, y = est, group = ancestry, color = ancestry)) +
  ...
  labs(x = "Global Genetic Ancestry Proportion", y = "Estimate and 95% CI", 
